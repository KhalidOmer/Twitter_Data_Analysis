...
sampletweetsjsonfile = "/home/khalid/Desktop/project1/Twitter_Data_Analysis/data"   #put here the path to where you placed the file e.g. ./sampletweets.json. 
_, tweet_list = read_json(sampletweet.json)
